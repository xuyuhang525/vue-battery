<template>
  ...
  <div class="app-container">
    <div class="rowBC" style="margin-bottom: 20px">
      <div class="text-info">备注：同一放电深度不同电池参数比较</div>
      <div>
        <el-button
          type="primary"
          plain
    ...
    >
      ...
      <el-table-column prop="title" label="DOD">
        <template slot-scope="scope"> {{ scope.row.title * 100 }}</template>
      </el-table-column>
      ...
      <el-table-column prop="massEnergyDensity" label="质量能量密度/W/kg">
      </el-table-column>
    ...
    <upload
      @over="over"
      title="同一放电深度不同电池参数比较信息导入"
      uploadUrl="/fdsd/import"
      ref="exportTable"
    ></upload>
  </div>
</template>
